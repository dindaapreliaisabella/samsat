      ...
      <nav id="mainav" class="fl_right">
        <ul class="clear">
          ...
          <li class="active"><a class="drop" href="#">Profil</a>
            <ul>
              <li class="active"><a href="profil.php">Sejarah</a></li>
              <li><a href="visimisi.php">Visi Misi</a></li>
              <li><a href="strukturorg.php">Sturktur Organisasi</a></li>
          ...
          <li><a href="../samsat/info/info.php">Info</a></li>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      <div id="gallery">
        <figure>
          <header class="heading">GALERI SAMSAT
          <ul class="nospace clear">
            <li class="one_quarter first"><a href="#"><img src="..\img\fk7.jpg" alt=""></a></li>
            <li class="one_quarter"><a href="#"><img src="..\img\fk1.jpg" alt=""></a></li>
            <li class="one_quarter"><a href="#"><img src="..\img\fk2.jpg" alt=""></a></li>
            <li class="one_quarter"><a href="#"><img src="..\img\fk3.jpg" alt=""></a></li>
            <li class="one_quarter first"><a href="#"><img src="..\img\fk4.jpg" alt=""></a></li>
            <li class="one_quarter"><a href="#"><img src="..\img\fk5.jpg" alt=""></a></li>
            <li class="one_quarter"><a href="#"><img src="..\img\fk6.jpg" alt=""></a></li>
            <li class="one_quarter"><a href="#"><img src="..\img\fk8.jpg" alt=""></a></li> 
